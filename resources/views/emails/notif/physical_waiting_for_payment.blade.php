    ...
    <body>
        <div style="max-width: 465px; font-family: 'Roboto'; margin:auto;">
            ...
            <div style="background-color: white; padding: 35px 15px 60px;">
                ...
                <!-- email content -->
                <div>
                    <h1 style="margin: 0; font-family: 'Roboto'; font-size: 18px; font-weight: bold; color: #666666; margin-bottom: 12px;">Menunggu Pembayaran</h1>
                    <p style="margin: 0; font-family: 'Roboto'; font-size: 14px; font-weight: normal; color: #666666; margin-bottom: 35px; line-height: 1.5;">Checkout berhasil pada {!! $order_date !!}</p>
                    <!-- payment content -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="margin-bottom: 25px;">
                                    <div style="font-family: 'Roboto'; font-size: 12px; font-weight: bold; color: #666666; margin-bottom: 7px;">Batas Waktu Pembayaran</div>
                                    <div style="font-family: 'Roboto'; font-size: 14px; font-weight: normal; color: #666666;">{!! $expire_date !!}</div>
                                </div>        
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div style="margin-bottom: 25px;">
                                    ...
                                    <div style="font-family: 'Roboto'; font-size: 14px; font-weight: normal; color: #666666;">Menunggu Pembayaran</div>
                                </div>        
                            </td>
                        </tr>
                    </table>
